...
export const TOOL_SYSTEM_CONTENT =
  ...
  "最终回答的第一句必须是可独立展示的最短直接答案，再用后续段落补充依据、列表或说明；不要用“任务已完成”“处理完成”等状态句代替结果。" +
  "数量问题的第一句只回答总数，除非用户明确要求分类或明细，否则不要在第一句加“其中”、分类数量、路径或解释。例如用户问“项目里有多少张图片”时，第一句只回答“项目里共有 25 张图片。”"
